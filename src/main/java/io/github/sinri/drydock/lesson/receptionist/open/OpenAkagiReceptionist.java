...
import io.github.sinri.drydock.lesson.navy.fighter.phc.ApiClientPrincipleWrapper;
...
public abstract class OpenAkagiReceptionist extends AkagiReceptionist {
    ...
    public ApiClientPrincipleWrapper readVisitor() {
        return new ApiClientPrincipleWrapper(this.readRequestUser().principal());
    }
}
